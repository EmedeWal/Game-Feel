    ...
    namespace Player
    {
        public class Handler
        {
            ...
            public void ResetLastPosition()
            {
                ...
                _d.CurrentLocomotion = LocomotionState.Grounded;
                _d.PreviousLocomotion = LocomotionState.Grounded;
                _d.Transform.position = _d.LastGroundedPosition;
            }

            public void PerformDash()
            {
                _d.DisableInput(_d.DashDuration);
                _d.AudioSystem.Play(_d.DashData);
                _d.OnDashCooldownStarted(_d.DashCooldown);
            ...
            public void PerformJump(LocomotionState state, Vector2 direction)
            {
                ...
                _d.AudioSystem.Play(_d.JumpData);
            ...
            {
                return state != LocomotionState.Dashing && state != LocomotionState.Hanging && _d.DashOffCooldown;
            }
            ...
            HandlePhysicsChecks()
            {
                ...
                if (grounded)
                {
                    _d.LastGroundedPosition = _d.Transform.position;
